...
use gui2::scene::{Scene, draw_scene, click_at};
...
fn make_scene() -> Scene {
    ...
    // );
    //
    // scene.add_view_to_root(make_button("button1", "A button").position_at(10, 60));
    scene.add_view_to_root(make_toggle_button("toggle1","Toggle Me").position_at(30,50));
    // scene.add_view_to_root(make_button("button2", "A button").position_at(10, 120));
    //
    // scene.add_view_to_root(make_button("button3", "A button").position_at(10, 200));
